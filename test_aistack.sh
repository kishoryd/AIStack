...
# ─── MAIN TEST RUNNER ────────────────────────────────────────────────────────
# run_env_test ENV PYVER "import1 import2 ..." DISPLAY_NAME
run_env_test() {
...
section "FINETUNING"
run_env_test unsloth      3.11 "torch torchvision torchaudio unsloth triton"   "Unsloth"
run_env_test transformers 3.11 "torch torchvision torchaudio transformers"     "Transformers"
run_env_test accelerate   3.11 "torch torchvision torchaudio accelerate"       "Accelerate"
run_env_test trl          3.11 "torch torchvision torchaudio trl"              "TRL"
run_env_test axolotl      3.11 "torch torchvision torchaudio axolotl"          "Axolotl"
run_env_test llamafactory 3.11 "torch torchvision torchaudio llamafactory"     "LLaMA-Factory"
run_env_test torchtune    3.11 "torch torchvision torchaudio torchtune"        "TorchTune"
run_env_test deepspeed    3.11 "torch torchvision torchaudio deepspeed"        "DeepSpeed"

section "INFERENCE"
run_env_test vllm         3.11 "torch vllm"                                    "vLLM"
run_env_test sglang       3.11 "torch sglang"                                  "SGLang"
run_env_test lmdeploy     3.11 "torch lmdeploy"                                "LMDeploy"
run_env_test rayserve     3.11 "torch ray vllm"                                "Ray Serve"
run_env_test tgi          3.11 "torch text_generation"                         "TGI"

section "RAG"
run_env_test llamaindex   3.11 "torch llama_index chromadb qdrant_client pymilvus sentence_transformers fastapi gradio"            "LlamaIndex"
run_env_test langchain    3.11 "torch langchain langchain_core langgraph langsmith chromadb qdrant_client sentence_transformers streamlit fastapi" "LangChain"
run_env_test haystack     3.11 "torch haystack chromadb qdrant_client sentence_transformers fastapi streamlit"                     "Haystack"

section "LEGACY"
run_env_test pytorch_gpu  3.10 "torch torchvision"  "PyTorch GPU"
run_env_test tensorflow   3.10 "tensorflow"          "TensorFlow GPU"
run_env_test Theano       3.11 "theano"              "Theano"
run_env_test Caffe        3.11 "caffe"               "Caffe"
